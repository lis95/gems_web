...
var GeneralResponse = (function () {
    ...
    ], GeneralResponse.prototype, "status", void 0);
    __decorate([
        type_graphql_1.Field(function () { return String; }, { nullable: true }),
        __metadata("design:type", String)
    ], GeneralResponse.prototype, "message", void 0);
    GeneralResponse = __decorate([
        type_graphql_1.ObjectType({ description: 'General Response' })
    ], GeneralResponse);
